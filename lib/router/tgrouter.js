      ...
      if ((!nobuffer) && this.bufferTimeout > 0) {
        if (Array.isArray(to)) {
          to.forEach((function(_this) {
            return function(to) {
              _this.messageBuffer[to + '_' + message_id_temp] = _this.messageBuffer[to + '_' + message_id_temp] || [];
              _this.messageBuffer[to + '_' + message_id_temp].push(message);
          ...
          this.messageBuffer[to + '_' + message_id_temp] = this.messageBuffer[to + '_' + message_id_temp] || [];
          this.messageBuffer[to + '_' + message_id_temp].push(message);
