(function() {
  var Media, Message, Senter, Telegram, TelegramFile, TelegramRouter, TelegramText, TextRouter, UTF8LengthSplit, User, co, createBotMessage, createMediaFromPhotoList, createSenderFromMessage, createSenderFromUser,
  ...
  createSenderFromMessage = function(message, telegramRouter) {
    return co(function*() {
      var api, channelId, channelInfo, e, error, error1, sender, userInfo, userName, userPhoto, userPhotoMedias;
  ...
  createSenderFromUser = function(user, telegramRouter) {
    return co(function*() {
      var channelId, e, error, sender, userInfo, userName, userPhoto, userPhotoMedias;
      try {
