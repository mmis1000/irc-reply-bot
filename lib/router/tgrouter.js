(function() {
  ...
  createSenderFromMessage = function(message, telegramRouter) {
    return co(function*() {
      var api, cachedChannel, cachedUser, channelId, channelInfo, channelPhoto, channelPhotoMedia, channelPhotoMedias, compareStr, compareStr1, e, error, error1, sender, userInfo, userName, userPhoto, userPhotoMedias;
