(function() {
  ...
  TextRouter = (function(_super) {
    ...
    TextRouter.prototype.output = function(message, to) {
      var item, person, temp, text, _i, _j, _k, _l, _len, _len1, _len2, _len3;
    ...
    TextRouter.prototype.outputMessage = function(message, to) {
      if (message.medias.length > 0) {
        return Q.all(message.medias.map(function(i) {
          ...
          return function(results) {
            return Q.all(results.map(function(i) {
              return _this.output(i.data.link, to);
            }));
          };
        })(this));
      } else {
        return this.output(message.text, to);
      }
    };
