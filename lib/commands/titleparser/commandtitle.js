(function() {
  ...
  CommandTitle = (function(superClass) {
    extend(CommandTitle, superClass);

    function CommandTitle(storage1) {
    ...
    CommandTitle.prototype._toggle = function(value, sender) {
      if ('object' !== typeof this.setting.enabled) {
        this.setting.enabled = {};
      }
    ...
    CommandTitle.prototype._loadPlugins = function() {
      var e, error1, i, len, plugin, plugins, results;
  ...
  })(virtual_class(EventEmitter, Icommand));
