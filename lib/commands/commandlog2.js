(function() {
  ...
  CommandLogs = (function(superClass) {
    ...
    CommandLogs.prototype.handleRaw = function(sender, type, content, textRouter, commandManager) {
      ...
      if (type === "message") {
        if (sender.senderInfo) {
          this._saveUser(sender.senderInfo);
        }
        if (sender.targetInfo) {
          this._saveUser(sender.targetInfo);
        }
        if (sender.channelInfo) {
          this._saveUser(sender.channelInfo);
        }
    ...
    CommandLogs.prototype._saveUser = function(userInfo) {
      ...
      return mediasPromise.then((function(_this) {
        ...
        return console.log("userInfo for " + user._id + " have been updated");
      })["catch"](function(err) {
