        ...
        if (content.asText && content.medias.length === 0) {
          ...
          (Q.all(content.medias.map((function(_this) {
            ...
            return function() {
              ...
              return mongoMessage = new _this.Message({
                from: sender.sender,
                to: sender.target,
                message: content.text,
                isOnChannel: onChannel,
