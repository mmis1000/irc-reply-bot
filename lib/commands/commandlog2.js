(function() {
  var CommandLogs, Grid, Icommand, LRU, Q, escapeRegex, moment, mongoose, mubsub,
  ...
  CommandLogs = (function(superClass) {
    ...
    function CommandLogs(dbpath, timezone, locale, collectionName, gridFSCollectionName) {
      ...
      this.MessageChannel = this.MessageChannel.channel(this.collectionName + "Trigger");
    ...
    CommandLogs.prototype.handleRaw = function(sender, type, content, textRouter, commandManager) {
      ...
      if (!this.Message) {
        ...
        this.db.once('open', (function(_this) {
          return function() {
            return _this.handleRaw.apply(_this, arguments);
          };
        })(this));
        return;
      }
      ...
      if (type === "outputMessage") {
        textRouter.getSelfInfo().then((function(_this) {
          return function(user) {
            if (user) {
              return _this._saveUser(user);
            }
          };
        })(this));
    ...
    CommandLogs.prototype._saveUser = function(userInfo, manager) {
      ...
      mediasPromise = Q.all(userInfo.images.map((function(_this) {
        return function(media) {
          var date;
          date = new Date;
          media.meta = media.meta || {};
      ...
      return mediasPromise.then((function(_this) {
        return function(medias) {
          user.images = medias.map(function(media) {
            return media._id;
          });
          return _this.User.findOneAndUpdate({
            _id: user.id
          }, user, {
            upsert: true,
            "new": true
        ...
        return function(user) {
          ...
          return _this.MessageChannel.publish('user-update', {
            'data': user.toObject()
          });
        };
      })(this))["catch"](function(err) {
