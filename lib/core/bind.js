(function() {
  ...
  Bind = (function(_super) {
    ...
    Bind.prototype._getBindingInfos = function(original, commandManager, sender, router) {
      var e, keyword, newKeyword, regex, replace, results, text, _i, _len, _ref;
      results = [];
      if ((original.search(escapeRegex(commandManager.identifier))) !== 0) {
        _ref = this.keywords;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    ...
    Bind.prototype._init = function() {
      var bindAppendCommand, bindCommand, bindListCommand, bindSearchCommand, bindShowCommand, unbindCommand;
      ...
      return this.registerCommand('show', bindShowCommand, []);
    };
    ...
    Bind.prototype._commandBindSearch = function(sender, text, args, storage, textRouter, commandManager) {
      var binding, bindings, index, searchText, _i, _len;
      if (args.length === 1) {
        return false;
      }
