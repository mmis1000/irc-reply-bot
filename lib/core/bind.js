(function() {
  ...
  Bind = (function(_super) {
    ...
    Bind.prototype.handle = function(senter, text, args, storage, textRouter, commandManager) {
      var success;
    ...
    Bind.prototype.help = function(commandPrefix) {
      console.log("add method to override this!");
      return [];
    };

    Bind.prototype.hasPermission = function(sender, text, args, storage, textRouter, commandManager) {
      return true;
    };
    ...
    Bind.prototype.handleRaw = function(sender, type, content, textRouter, commandManager) {
      ...
      if (type === 'before_iscommand') {
        result = this._getBinding(content.text, commandManager);
        if (result !== false) {
          content.text = result;
    ...
    Bind.prototype._getBinding = function(original, commandManager) {
      var e, keyword, regex, result, text, _i, _len, _ref;
      result = false;
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          try {
            if ((original.search(keyword)) >= 0) {
              ...
              text = (regex.exec(original))[0].replace(regex, this.keywordMap[keyword]);
              break;
            }
          } catch (_error) {
            e = _error;
    ...
    Bind.prototype._init = function() {
      ...
      this.manager.register('bind', bindCommand, []);
      bindAppendCommand = {
        handle: (function(_this) {
          return function(sender, text, args, storage, textRouter, commandManager) {
      ...
      this.manager.register('bindappend', bindAppendCommand, []);
      unbindCommand = {
        handle: (function(_this) {
          return function(sender, text, args, storage, textRouter, commandManager) {
      ...
      this.manager.register('unbind', unbindCommand, []);
      bindListCommand = {
        handle: (function(_this) {
          return function(sender, text, args, storage, textRouter, commandManager) {
      ...
      return this.manager.register('bindlist', bindListCommand, []);
    };
