...
(function() {
  ...
  CommandSay = (function(_super) {
    ...
    CommandSay.prototype.handle = function(sender, text, args, storage, textRouter, commandManager) {
      ...
      commandManager._sendToPlace(textRouter, sender.sender, sender.target, sender.channel, "I have been here for " + (day > 0 ? day + ' day, ' : '') + "" + (padding(hour, "0", 2)) + ":" + (padding(minute, "0", 2)) + ":" + (padding(second, "0", 2)) + " .");
      return true;
    };
