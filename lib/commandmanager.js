(function() {
  var Ban, Bind, CommandManager, EventEmitter, Icommand, Message, PipeRouter, Sender, TraceRouter, co, escapeRegex,
  ...
  CommandManager = (function(superClass) {
    ...
    CommandManager.prototype.handleText = function(sender, text, textRouter, opts, originalMessage) {
      var done, result;
      if (opts == null) {
        opts = {};
      }
    ...
    CommandManager.prototype._sendToPlace = function(textRouter, from, to, channel, text) {
    ...
    CommandManager.prototype.selectRouter = function(target, currentRouter) {
      var i, len, ref, router, routerId, targetId;
        ...
        return function(info) {
          ...
          if (_this.isOp(info.account, true)) {
            if (command) {
              ...
              _this.handleText(sender, command, trace, {
                fromBinding: false,
                isCommand: true,
                args: args.slice(1)
              });
              trace.forceCheck();
              return trace.promise.then(function() {
