(function() {
  var Ban, Bind, CommandManager, EventEmitter, Icommand, Message, TraceRouter, co, escapeRegex,
  ...
  CommandManager = (function(superClass) {
    ...
    CommandManager.prototype.handleText = function(sender, text, textRouter, opts, originalMessage) {
      ...
      return co.call(this, function*() {
        var args, command, commandManager, currentIdentifier, fromBinding, identifierRegex;
        ...
        if (!textRouter.isCommand) {
          result.isCommand = result.isCommand || ((text.search(escapeRegex(currentIdentifier))) === 0);
        } else {
