(function() {
  ...
  CommandManager = (function(_super) {
    ...
    function CommandManager(storage, textRouter) {
      var banCommand, banListCommand, bindAppendCommand, bindCommand, bindListCommand, deopCommand, helpCommand, opCommand, sudoCommand, unbanCommand, unbindCommand;
      this.storage = storage;
      this.identifier = "!";
      this.commandFormat = /^[a-zA-Z1-9]+$/g;
      this.keywordPrefix = "^";
    ...
    CommandManager.prototype.handleText = function(sender, text, textRouter, isCommand, fromBinding) {
      var args, argsText, command, commandmanager, i, keyword, result, _i, _j, _len, _len1, _ref, _ref1;
      if (isCommand == null) {
        isCommand = false;
      }
      if (fromBinding == null) {
      ...
      result = false;
      if ((text.search(this.identifier)) !== 0 && !isCommand) {
        fromBinding = true;
        _ref1 = this.keywords;
    ...
    CommandManager.prototype.parseArgs = function(text) {
      var args, argsText;
      argsText = 0 === (text.search(this.identifier)) ? text.replace(this.identifier, "") : text;
      argsText = argsText.replace(/^\s*/g, "");
      args = argsText.split(" ");
      return args;
    };
