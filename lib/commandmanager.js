(function() {
  var Ban, Bind, CommandManager, EventEmitter, Icommand, Message, escapeRegex,
    ...
    CommandManager.prototype.addRouter = function(textRouter) {
      ...
      textRouter.on("input", (function(_this) {
        return function(message, sender, router) {
          ...
          _this.handleRaw(sender, "message", new Message(message, [], true, true), router);
      ...
      textRouter.on("message", (function(_this) {
        return function(message, sender, router) {
          ...
          if (message.asCommand) {
            return _this.handleText(sender, message.text, router);
          }
        };
      })(this));
