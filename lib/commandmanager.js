(function() {
  var Ban, Bind, CommandManager, EventEmitter, escapeRegex,
  ...
  CommandManager = (function(_super) {
    ...
    CommandManager.prototype.handleText = function(sender, text, textRouter, isCommand, fromBinding) {
      var args, argsText, command, commandManager, identifierRegex, result;
      if (isCommand == null) {
        isCommand = false;
      }
      if (fromBinding == null) {
      ...
      result = {};
      commandManager = this;
      result.isCommand = isCommand || (text.search(escapeRegex(this.identifier))) === 0;
    ...
    CommandManager.prototype.load = function(moudle) {
      ...
      return moudle.handleRaw(null, 'init', null, null, this);
    };
